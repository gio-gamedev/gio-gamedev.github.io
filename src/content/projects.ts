  ...
  p('Pro Kick Simulator', 'Roblox', {
    ...
    contribution: {
      en: [
        ...
        'Defects investigated and tracked to the fix, including issues raised by the player community',
      ],
      pt: [
        ...
        'Defeitos investigados e acompanhados até a correção, incluindo relatos vindos da comunidade de jogadores',
      ],
    },
    detail: {
      en: [
  ...
  p('Football Tycoon (Soccer Tycoon)', 'Fortnite/UEFN', {
    ...
    detail: {
      en: [
        ...
        'Defects documented and tracked, and the fixes verified',
      ...
      pt: [
        ...
        'Defeitos documentados e acompanhados, com as correções validadas',
  ...
  p('The Walking Dead: Through the Tower', 'The Sandbox', {
    ...
    contribution: {
      en: [
        ...
        'Exploratory and regression testing, with defects documented and the fixes verified',
      ...
      pt: [
        ...
        'Testes exploratórios e de regressão, com defeitos documentados e correções validadas',
    ...
    detail: {
      en: [
        ...
        'Defects identified, documented and tracked to their fix',
      ...
      pt: [
        ...
        'Defeitos identificados, documentados e acompanhados até a correção',
  ...
  p('Logic Pic', 'Mobile', {
    ...
    contribution: {
      en: [
        ...
        'Defects documented and tracked on the backlog until the fix was verified',
      ],
      pt: [
        ...
        'Defeitos documentados e acompanhados no backlog até a correção ser validada',
      ],
    },
    detail: {
      en: [
        ...
        'Defects documented and their progress followed on the backlog',
      ...
      pt: [
        ...
        'Defeitos documentados e acompanhados no backlog',
  ...
  p('Rumble Kong League', 'Mobile', {
    ...
    detail: {
      en: [
        ...
        'Defects documented with evidence, and the fixes verified',
      ],
      pt: [
        ...
        'Defeitos documentados com evidências, e correções validadas',
      ],
    },
    compliance: {
